...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      require('transparent').setup {
        ...
        extra_groups = { -- list of groups that should be transparent
          -- example: 'NvimTreeNormal', 'NormalFloat', etc.
          -- more groups can be added here
        },
        exclude = {}, -- groups that should NOT be transparent
      }
    end,
  },
  {
  ...
  dependencies = {
    ...
    { 'j-hui/fidget.nvim', opts = {} }, -- Optional, for status updates
  ...
  config = function()
    ...
    -- Define language servers and their settings
    local servers = {
      lua_ls = {
        settings = {
          Lua = {
    ...
    -- Install LSP servers via mason-tool-installer
